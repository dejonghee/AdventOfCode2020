...
namespace AdventOfCode.UnitTests
{
    ...
    public class ValidateSolutions
    {
        ...
        [TestMethod]
        public async Task Day22()
        {
            await Validate<Day22, int, int>(32489, 35676);
        }

        [TestMethod]
        public async Task Day23()
        {
            await Validate<Day23, string, string>("78569234", "565615814504");
        }

        [TestMethod]
        public async Task Day24()
        {
            await Validate<Day24, int, int>(275, 3537);
        }

        [TestMethod]
        public async Task Day25()
        {
            //await Validate<Day25, long, string>("", "");
            await ValidatePart1<Day25, long, string>(18293391);
            //await ValidatePart2<Day25, string, string>("");
        }
